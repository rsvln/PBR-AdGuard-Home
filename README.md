...
### Схема 1: AdGuard Home на порту 53 (рекомендуемая)
...
**Новые установки**: используйте Схему 1 (AdGuard Home на 53)
**Существующие системы**: Схема 3 (текущая с redirect)
**Высоконагруженные сети**: Схема 2 (отдельный сервер)
